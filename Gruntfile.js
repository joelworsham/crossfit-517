...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            sass: {
                files: ['assets/sass/**/*.scss', '!assets/sass/admin/**/*.scss', '!assets/sass/schedule/**/*.scss'],
                tasks: ['sass:front', 'autoprefixer:front', 'notify:sass']
            },
            sass_schedule: {
                files: ['assets/sass/schedule/**/*.scss'],
                tasks: ['sass:schedule', 'autoprefixer:schedule', 'notify:sass']
            },
            sass_admin: {
        ...
        sass: {
            ...
            schedule: {
                files: {
                    'assets/css/schedule.css': 'assets/sass/schedule/schedule.scss'
                }
            },
            admin: {
                files: {
